      ...
      <div className={styles.container}>
        ...
        <div className={styles.cardsContainer}>
          {displayReviews.length > 0 ? (
            <>
              ...
              {displayReviews[0] && (
                <div className={`${styles.reviewCard} ${styles.card1}`}>
                  ...
                  <p className={styles.reviewText}>
                    {displayReviews[0].text || 'The level of sophistication Model Mortgage brought to our multi-property acquisition was unparalleled. They navigate complex financial structures with surgical precision.'}
                  </p>
              ...
              {displayReviews[1] && (
                <div className={`${styles.reviewCard} ${styles.card2}`}>
                  <span className={styles.quoteIcon}>"</span>
                  <p className={styles.reviewText}>
                    {displayReviews[1].text || 'In the Houston luxury market, speed is currency. Model Mortgage secured our financing in record time without compromising on the terms.'}
                  </p>
                  <div className={styles.cardFooter}>
                    <div className={styles.authorInfo}>
                      <ReviewAvatar
              ...
              {displayReviews[2] && (
                <div className={`${styles.reviewCard} ${styles.card3}`}>
                  <span className={styles.quoteIcon}>"</span>
                  <p className={styles.reviewText}>
                    {displayReviews[2].text || 'Finally, a mortgage lender that understands the needs of business owners. A truly institutional experience from start to finish.'}
                  </p>
                  <div className={styles.cardFooter}>
                    <div className={styles.authorInfo}>
                      <ReviewAvatar
            ...
            <p className={styles.noReviews}>Loading client reviews...</p>
          )}
        </div>
      </div>
    </section>
