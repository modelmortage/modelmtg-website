...
function StepBlock({
  ...
  return (
    <mesh position={position} castShadow receiveShadow>
      ...
      <meshStandardMaterial color="#08090b" roughness={0.88} metalness={0.12} />
    </mesh>
  );
}
...
function Scene() {
  return (
    <>
      ...
      <directionalLight position={[-3, 5, 5]} intensity={0.78} color="#d9dde2" />
      <directionalLight position={[-6, -1, 3]} intensity={0.16} color="#6f7780" />
      <pointLight position={[-2.5, 1.5, 4]} intensity={0.24} color="#d5d8dc" />
