      ...
      <div className={styles.calculatorWrapper}>
        ...
        <div className={styles.resultsPanel}>
          <div className={styles.resultCards}>
            ...
            <Card variant="elevated" padding="md" className={styles.resultCard}>
              <div className={styles.resultLabel}>Purchase Price</div>
              <div className={styles.resultValue}>${results.purchasePrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
            </Card>

            <Card variant="elevated" padding="md" className={styles.resultCard}>
              <div className={styles.resultLabel}>Down Payment</div>
              <div className={styles.resultValue}>${results.downPayment.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
            </Card>
          </div>
          ...
          <Card variant="elevated" padding="md" className={styles.summaryCard}>
            ...
            <p className={styles.summaryText}>
              Based on what you input, your Total Payment would be{' '}
              ...
              <strong>
                {results.purchasePrice > 0
                  ...
                  : '0.00'}% Down Payment
              </strong> on a home priced at <strong>${results.purchasePrice.toLocaleString()}</strong>.
            </p>
          </Card>
        </div>
      </div>
