...
describe('Matthew Bramow Page Breadcrumb Structured Data (Requirement 6.6)', () => {
  ...
  it('should have correct breadcrumb hierarchy', () => {
    ...
    if (breadcrumbScript) {
      ...
      // Should have 3 levels: Home > Meet Our Team > Matthew Bramow
      ...
      // Validate third item (Matthew Bramow)
